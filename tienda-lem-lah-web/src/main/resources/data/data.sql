...
INSERT INTO marcas (nombre, descripcion, imagen) VALUES
                                                     ...
                                                     ('Prestige Pets',   'Sin productos aún — marca sin productos',  'prestigepets.jpg');
...
INSERT INTO categorias (nombre, descripcion, imagen, tipo) VALUES
                                                               ...
                                                               ('Raw & Natural',    'CANINO · NATURAL',   'rawnatural.jpg',    'perros'),
                                                               ('Kitten Premium',   'FELINO · JUNIOR',    'kittenpremium.jpg', 'gatos');
...
('0000000000013', 'Bison & Sweet Potato Grain-Free',
 ...
 'bisonSweetPotato.jpg', 32.99, 0, 3),
...
-- SITUACIÓN 3: producto 20 (Mystery Blend) y producto sin categoría asignada — sin INSERT aquí
-- SITUACIÓN 7: categoría 4 (Salmon & Caviar) ya tiene solo un producto exclusivo (productos 5,12,21 comparten)
-- SITUACIÓN 6: categorías 5 (Raw & Natural) y 6 (Kitten Premium) — sin INSERT aquí
-- SITUACIÓN 2: marca 4 (Prestige Pets) — sin productos → cumplida arriba
-- SITUACIÓN 1: marcas 1, 2, 3 tienen múltiples productos → cumplida arriba